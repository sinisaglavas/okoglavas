    ...
    <div class="container">
        <div class="row">
            <div class="col-3">
                ...
                <a href="{{ route('home.showExaminationForm',['id'=>$single_client->id]) }}" class="btn btn-light form-control m-2">{{ $single_client->name }} - Novi pregled</a>
            </div>
            <div class="col-1"></div>
            <div class="col-8">
            ...
            <div class="col-8">
               ...
               <table class="table text-center table-bordered caption-top" style="background-color: rgb(200,200,200)">
                   ...
                   <tr>
                       ...
                       @endif
                       <td></td>
                       <td style="background-color: #ffc107;"><a href="/distance-form/{{$distance->id}}/edit" style="text-decoration: none; color: white; display: block">Edit</a></td>
